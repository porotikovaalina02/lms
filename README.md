...
- проходить тесты через inline-кнопки
- сохранять результаты в базу
- смотреть историю попыток
...
Токен берёшь у [@BotFather](https://t.me/BotFather) → `/newbot`
